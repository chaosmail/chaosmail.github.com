...
[Timo Grossenbacher][timo-twitter] gave an introduction to the very helpful [Learn JS Data][learnjsdata] website - a great starting point for all future Javascript data scientists. You will cool stuff including `map`, `redcue`, `Regular Expressions` and `D3.js nest`.

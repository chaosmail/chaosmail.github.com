...
You can follow the [guidelines in the Microsoft docs](https://docs.microsoft.com/en-us/sql/big-data-cluster/data-ingestion-curl?view=sqlallproducts-allversions) using `curl`.
